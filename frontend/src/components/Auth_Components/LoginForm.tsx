      ...
      >
        ...
        <div className="hidden lg:relative lg:block lg:p-12">
          ...
          <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
            Welcome to Land Listing
          </h2>
  
          <p className="mt-4 leading-relaxed text-white/90">
            please fill all the details to get started
          </p>
        </div>
      </section>
        ...
        <div className="max-w-xl lg:max-w-3xl">
          <div className="relative -mt-16 block ">
            ...
            >
              <span className="sr-only">Home</span>
              <svg
                className="h-8 sm:h-10 lg:hidden"
                viewBox="0 0 28 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            Welcome to Land listing , please fill all the details below. 🦑
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
            ...
            <div className="col-span-5">
              ...
              <input
                ...
                id="Email"
                name="email"
                className="mt-1 w-full border-2 py-2 px-4  rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
            ...
            <div className="col-span-5">
              ...
              <input
                ...
                onChange={handleChange}
                className="t-1 w-full border-2 py-2 px-4  rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
              />
            </div>
