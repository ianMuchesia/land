...
const Custom504 = () => {
  ...
  <div className="text-center">
    ...
    <h1 className="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">504 - Server Error</h1>
    <p className="text-slate-600 mt-5 lg:text-lg">Oops something went wrong. Please check your connection and try to refresh this page or <br/> feel free to contact us if the problem presists.</p>
  </div>
</div>
  )
}
